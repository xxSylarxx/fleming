    ...
    <section class="container" id="metodologia">
        <div id="visitas" class="row justify-content-between align-items-center">
            <div class="col-md-6 px-lg-4">
                ...
                <p>
                    Nuestro personal dedicado a la guía y orientación del
                    educando de primaria busca, mediante diversas estrategias
                    metodológicas y aplicando una disciplina asertiva, el desarrollo
                    de la inteligencia emocional, tan valorada en el contexto laboral actual.
                </p>
            </div>
            <div class="col-md-6 px-lg-4 d-flex justify-content-center">
                <div class="swiper mySwiper" id="imageborder">
                    <div class="swiper-wrapper">
                        <div class="swiper-slide"><img src="./assets/img/fotos/primaria1.jpg" alt=""></div>
                        <div class="swiper-slide"><img src="./assets/img/fotos/primaria2.jpg" alt=""></div>
