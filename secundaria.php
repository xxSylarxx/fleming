        ...
        <div id="visitas" class="row justify-content-between align-items-center">
            <div class="col-md-6 px-lg-4">
               <h2 style="color:var(--color1);font-weight:800;text-align:center;">NIVEL SECUNDARIA</h2>
                <br>
                <p>
                    En los momentos actuales nuestra sociedad exige una Educación de
                    ...
                    y actitudes acordes al desarrollo del estudiante, lo que permitirá
                    fortalecer con mayor énfasis los aprendizajes dentro de un proceso
                    dinámico en función de los avances del conocimiento; ante esta realidad
                    nuestra Institución Educativa viene incorporando en las diversas áreas
                    académicas del Nivel de Educación Secundaria, capacidades y conocimientos
