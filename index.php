        ...
        <div class="row justify-content-between">
            <div class="col-lg-6 my-2 scroll">
                ...
                <p style="line-height: 2; text-align: justify;">
                    A nombre de toda la Institución Educativa queremos darte la bienvenida a nuestro colegio; donde encontrarás un ambiente muy familiar para todos los integrantes.
                </p>
                <p style="line-height: 2; text-align: justify;">
                    Nosotros tenemos una premisa muy clara; si nuestros
                    alumnos están contentos entonces aprenderán de una
                    forma que no olvidarán las competencias recibidas en
                    sus diferentes cursos. La fórmula es muy sencilla, si
                    los alumnos están contentos los papás también lo estarán. </p>
                <p style="line-height: 2; text-align: justify;">
                    A nombre de toda la Institución Educativa
                    queremos darte la bienvenida a nuestro colegio;
                    donde encontrarás un ambiente muy familiar para todos los integrantes.
                </p>
                ...
                <p style="line-height: 2; text-align: justify;">Tenemos la certeza que en nuestro hogar no se dé el bullying y predomine el respeto
                    y la tolerancia entre todos los miembros de la comunidad porque tenemos una cultura preventiva y formativa </p>
                <p style="line-height: 2; text-align: justify;">Finalmente queremos decirte que al ser parte de la familia Fleming serás parte de un equipo ganador </p>
                <p>Fraternalmente, </p>
                <p style="font-weight:bold;">Hno. Román Suclla Lazo </p>
